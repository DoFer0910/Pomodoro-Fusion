...
export const translations = {
  ja: {
    ...
    license: "ライセンス",
    licenseProDesc: "Proを購入するとCSV出力とプロジェクトの無制限作成が解放されます。",
    purchasePro: "Proを購入",
    licenseKeyLabel: "ライセンス鍵",
    licenseKeyPlaceholder: "購入時に発行された鍵を貼り付け",
    activateLicense: "有効化",
    deactivateLicense: "解除",
    licenseActive: "Pro 有効",
    licenseActiveDesc: "ご購入ありがとうございます。すべてのPro機能が使えます。",
    ...
    repoPathHint: "Claude Code と Codex の作業時間をこのプロジェクトに紐づけます",
    ...
    // AI エージェント連携（Claude Code / Codex）
    syncAgents: "AI 同期",
    claudeCodeTime: "Claude Code",
    codexTime: "Codex",
    agentSyncHint: "Claude Code と Codex の作業時間を取り込みます",
    agentSyncResult: "AI: 新規 {added} 件 / 更新 {updated} 件",
    agentSyncUnmatched: "（未登録リポジトリ {unmatched} 件）",
    agentSyncFailed: "AI 作業時間の同期に失敗しました",
  ...
  en: {
    ...
    license: "License",
    licenseProDesc: "Buy Pro to unlock CSV export and unlimited projects.",
    purchasePro: "Buy Pro",
    licenseKeyLabel: "License key",
    licenseKeyPlaceholder: "Paste the key issued at purchase",
    activateLicense: "Activate",
    deactivateLicense: "Deactivate",
    licenseActive: "Pro active",
    licenseActiveDesc: "Thank you for your purchase. All Pro features are unlocked.",
    ...
    repoPathHint: "Link Claude Code and Codex working time to this project",
    ...
    claudeCodeTime: "Claude Code",
    codexTime: "Codex",
    agentSyncHint: "Import Claude Code and Codex working time",
    agentSyncResult: "AI: {added} added / {updated} updated",
    agentSyncUnmatched: " ({unmatched} unregistered repos)",
    agentSyncFailed: "Failed to sync AI working time",
