        ...
        <div className="p-3 overflow-x-auto">
            <DayPicker
                ...
                classNames={{
                    ...
                    month: "space-y-4 w-full min-w-[450px]", // Minimum width to ensure 5 digits fit (~60px * 7)
                    ...
                    day: "h-24 w-full min-w-[60px] text-center text-sm p-0 relative [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
                    day_button: cn(
                                ...
                                <div className="w-full h-full p-1 flex flex-col items-start justify-between">
                                    ...
                                    {value && (
                                        <div className="w-full text-center mb-1 px-1">
                                            <span className={cn(
                                                "text-[10px] px-1 py-0.5 rounded-full inline-block w-full break-all",
                                                isBillable
